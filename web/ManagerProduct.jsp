<%-- 
    ...
    Created on : Jul 7, 2021, 9:37:00 AM
    Author     : ADMIN
--%>
            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="AddformControl"><button type="button" class="btn btn-primary">Add New Product</button>
